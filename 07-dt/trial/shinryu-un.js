...
Options.Triggers.push({
  ...
  triggers: [
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C439', source: 'Shinryu', capture: false },
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C46D', source: 'Shinryu', capture: false },
      infoText: (_data, _matches, output) => output.text(),
      outputStrings: {
        text: {
          en: 'Out of middle',
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C437', source: 'Shinryu', capture: false },
      durationSeconds: 7,
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C438', source: 'Shinryu', capture: false },
      durationSeconds: 7,
      alertText: (_data, _matches, output) => output.text(),
      outputStrings: {
        text: {
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C43E', source: 'Tail', capture: false },
      delaySeconds: 2,
      infoText: (_data, _matches, output) => output.text(),
      outputStrings: {
        text: {
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C466', source: 'Hakkinryu' },
      alertText: (data, matches, output) => {
        if (matches.target === data.me)
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C478', source: 'Shinryu' },
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C47D', source: 'Left Wing', capture: false },
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: 'C47E', source: 'Right Wing', capture: false },
      condition: (data) => !data.finalWing,
      alertText: (_data, _matches, output) => output.text(),
      run: (data) => data.finalWing = true,
      outputStrings: {
