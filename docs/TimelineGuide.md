...
* [Timeline Guide](#timeline-guide)
  ...
  * [Timeline File Syntax](#timeline-file-syntax)
    * [Comments](#comments)
    * [Entries](#entries)
    * [Keywords/Commands](#keywordscommands)
  ...
  * [Making a Timeline](#making-a-timeline)
    ...
    * [Using make_timeline.ts](#using-make_timelinets)
    * [Timeline Ability Tables](#timeline-ability-tables)
      * [Using the log splitter to find useful/interesting ability lines](#using-the-log-splitter-to-find-usefulinteresting-ability-lines)
    * [Using make_timeline.ts with fflogs](#using-make_timelinets-with-fflogs)
    * [Using test_timeline.ts](#using-test_timelinets)
    * [Using test_timeline.ts with fflogs](#using-test_timelinets-with-fflogs)
  ...
  * [Future Work](#future-work)
    * [Smaller Fixes/Changes](#smaller-fixeschanges)
