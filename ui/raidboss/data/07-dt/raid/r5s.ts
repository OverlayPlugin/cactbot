  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Arcady Night Encore': 'Arcady Night Encore',
        'Arcady Night Fever': '아르카디아의 밤의 열기',
        'Back-up Dance': 'Back-up Dance',
        ...
        'Fire': '파이어',
        'Flip to A-side': 'Flip to A-side',
        'Flip to B-side': 'Flip to B-side',
        'Freak Out': 'Freak Out',
        'Frogtourage Finale': 'Frogtourage Finale',
        'Frogtourage(?! )': '컴 온! 개구리 댄서',
        'Funky Floor': '댄싱 필드',
        'Get Down!': 'Get Down!',
        'Hi-NRG Fever': 'Hi-NRG Fever',
        'Inside Out': 'Inside Out',
        'Let\'s Dance!(?! Remix)': '레츠 댄스!',
        'Let\'s Dance! Remix': 'Let\'s Dance! Remix',
        'Let\'s Pose!': '레츠 포즈!',
        'Moonburn': '달볕 걸음',
        'Outside In': 'Outside In',
        'Play A-side': 'Play A-side',
        'Play B-side': 'Play B-side',
        'Quarter Beats': '4비트',
