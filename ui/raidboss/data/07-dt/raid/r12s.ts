  ...
  config: [
    {
      ...
      options: {
        ...
        ko: {
          '북쪽/양 옆 상대 전략: 북쪽 플레이어는 북동/북서, 남쪽 플레이어는 양 옆 기준으로 이동':
            'ns',
    ...
    },
    {
      ...
      options: {
        ...
        ko: {
          'DN: 보스 북, 부채꼴 북동/북서, 쉐어 동/서, 광역징 남동/남서, 무징 남': 'dn',
          '바나나 코덱스: 보스 서, 쉐어 북서/남서, 부채꼴 북/남, 광역징 북동/남동, 무징 동':
            'banana',
          '누케마루: 보스 동, 쉐어 북동/남동, 부채꼴 북/남, 광역징 북서/남서, 무징 서': 'nukemaru',
    ...
    },
    {
      ...
      options: {
        ...
        ko: {
          'DN: 북, 북동, 동, 남동 분신 대상자 쉐어징, 남, 남서, 서, 북서 분신 대상자 광역징. 파티를 4개의 대각선 구역으로 나눕니다.':
            'dn',
          'Emergency Meeting: 북, 북동, 동, 북서 쉐어, 남동, 남, 남서, 서 광역징. 파티를 빨강/보라 + 노랑/파랑 징으로 나누고 쉐어 또는 광역징이 먼저인지에 따라 위치를 바꿉니다.':
            'em',
          '카로: 북동, 동, 남서, 서 분신 대상자 쉐어징, 북, 남동, 남, 북서 분신 대상자 광역징. 파티를 4개의 대각선 구역으로 나눕니다.':
            'caro',
          '누케마루: 북, 남서, 서, 북서 분신 대상자 쉐어징, 북동, 동, 남동, 남 분신 대상자 광역징. 파티를 4개의 대각선 구역으로 나눕니다.':
            'nukemaru',
          '전략 없음: 자신에게 걸린 선과 선 가져가기만 알림': 'none',
        },
      },
    ...
    },
    {
      ...
      options: {
        ...
        ko: {
          'DN: 어둠 - 북 히트박스, 바람 - 중앙 히트박스, 땅/불 근딜 - 플랫폼 북쪽 (어둠/바람 사이), 불/땅 원딜 - 플랫폼 남쪽 가장자리':
            'dn',
          'Zenith: 바람 - 북 칼끝딜, 땅/어둠 - 중앙 (약간 북쪽), 불 - 남 칼끝딜': 'zenith',
          '누케마루: 가까이 - 남쪽 (숫자징 구석), 멀리 - 보스 히트박스, 땅/불 - 남쪽 칼끝딜, 불/땅 - 플랫폼 북쪽':
            'nukemaru',
    ...
    },
    {
      ...
      outputStrings: {
        ...
        alphaDir: {
          ...
          de:
            'Vermeide ${dir1} ${shape1}/${shape2} Form-AoEs => ${dir2} Schwarzes Loch + ${northSouth}',
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        '--tethers--': '--선--',
        '--n/s clones--': '--북/남 분신--',
        '--ne/sw clones--': '--북동/남서 분신--',
        '--e/w clones--': '--동/서 분신--',
        '--se/nw clones--': '--남동/북서 분신--',
        '--black holes--': '--블랙홀--',
        '--shapes--': '--도형--',
