    ...
    },
    {
      ...
      outputStrings: {
        text: {
          ...
          fr: 'Positions pour Rayon mystique',
          ja: '魔光位置へ',
          cn: '魔光站位',
          tc: '魔光站位',
          ko: '마광 산개',
    ...
    },
    {
      ...
      outputStrings: {
        ...
        outInterCardsProtean: {
          ...
          fr: 'Extérieur + Intercardinaux + Positions',
          ja: '外側 + 斜め + 散開',
          cn: '外侧 + 斜角 + 分散',
          tc: '外側 + 斜角 + 分散',
          ko: '밖 + 대각선 + 산개',
