  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        '\\(Towers\\)': '(탑)',
        'Aero III': '에어로가',
        'Aerotemporal Blast': 'Aerotemporal Blast',
        'Alpha Stone': 'Alpha Stone',
        'Alpha Wind': 'Alpha Wind',
        'Bare Fangs': '빛송곳니 소환',
        'Beckon Moonlight': '환영 늑대 소환',
        'Breath of Decay': 'Breath of Decay',
        'Champion\'s Circuit': 'Champion\'s Circuit',
        'Elemental Purge': 'Elemental Purge',
        'Eminent Reign': 'Eminent Reign',
        'Extraplanar Feast': 'Extraplanar Feast',
        'Extraplanar Pursuit': '공간 베기',
        'Fanged Charge': '돌진 빛송곳니',
        'Forlorn Stone': 'Forlorn Stone',
        'Forlorn Wind': 'Forlorn Wind',
        'Geotemporal Blast': 'Geotemporal Blast',
        'Gleaming Barrage': 'Gleaming Barrage',
        'Gleaming Beam': 'Gleaming Beam',
        'Great Divide': '일도양단',
        'Gust': '선풍',
        'Heavensearth': '대지진 공격',
        'Hero\'s Blow': 'Hero\'s Blow',
        'Howling Eight': 'Howling Eight',
        'Howling Havoc': 'Howling Havoc',
        'Hunter\'s Harvest': 'Hunter\'s Harvest',
        'Lone Wolf\'s Lament': 'Lone Wolf\'s Lament',
        'Millennial Decay': 'Millennial Decay',
        'Moonbeam\'s Bite': '환랑검',
        'Mooncleaver': 'Mooncleaver',
        'Pack Predation': 'Pack Predation',
        'Prowling Gale': '풍랑진',
        'Quake III': '퀘이가',
        'Ravenous Saber': '풍진광랑참',
        'Revolutionary Reign': 'Revolutionary Reign',
        'Rise of the Howling Wind': 'Rise of the Howling Wind',
        'Rise of the Hunter\'s Blade': 'Rise of the Hunter\'s Blade',
        'Roaring Wind': '풍랑호파',
        'Shadowchase': '잔영검',
        'Stalking Stone': 'Stalking Stone',
        'Stalking Wind': 'Stalking Wind',
        'Starcleaver': 'Starcleaver',
        'Stonefang': 'Stonefang',
        ...
        'Twinbite': 'Twinbite',
        'Twofold Tempest': 'Twofold Tempest',
        'Ultraviolent Ray': 'Ultraviolent Ray',
        'Weal of Stone': '지열파',
        'Wind Surge': '바람 폭발',
        'Windfang': 'Windfang',
        'Winds of Decay': 'Winds of Decay',
        'Wolves\' Reign': '군랑검',
      },
    },
  ],
