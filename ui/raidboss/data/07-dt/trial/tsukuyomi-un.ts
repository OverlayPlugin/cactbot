...
const triggerSet: TriggerSet<Data> = {
  ...
  triggers: [
    ...
    },
    {
      ...
      type: 'StartsUsing',
      netRegex: { id: ['B12F', 'B16A'], source: 'Tsukuyomi' },
    ...
    {
      id: 'TsukuyomiUn Bright Blade',
      type: 'StartsUsing',
      netRegex: { id: 'B14F', source: 'Tsukuyomi', capture: false },
      infoText: (data, _matches, output) => {
        if (data.moonIsOut)
    ...
    {
      id: 'TsukuyomiUn Lunacy',
      type: 'HeadMarker',
      netRegex: { id: '003E', capture: false },
      response: Responses.stackMarker(),
    },
    {
      id: 'TsukuyomiUn Hagetsu',
      type: 'HeadMarker',
      netRegex: { id: '0017' },
      condition: Conditions.targetIsYou(),
    ...
    {
      id: 'TsukuyomiUn Supreme Selenomancy',
      type: 'Ability',
      netRegex: { source: 'Tsukuyomi', id: 'B169', capture: false },
      suppressSeconds: 5,
      run: (data) => {
    ...
    {
      id: 'TsukuyomiUn Moonshadowed Debuff Logic',
      type: 'GainsEffect',
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Steel Of The Underworld': 'Blei der Unterwelt',
