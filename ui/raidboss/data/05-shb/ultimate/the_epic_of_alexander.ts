  ...
  config: [
    {
      ...
      name: {
        ...
        cn:
          '启用 cactbot 次元断绝策略: https://ff14.toolboxgaming.space/?id=17050133675751&preview=1',
        ko:
          'cactbot 웜홀 공략방식 사용: https://ff14.toolboxgaming.space/?id=17050133675751&preview=1',
        tc:
          '啟用 cactbot 次元斷絕策略: https://ff14.toolboxgaming.space/?id=17050133675751&preview=1',
      },
      type: 'checkbox',
      default: (options) => {
  ...
  timelineReplace: [
    ...
    },
    {
      ...
      'replaceText': {
        ...
        'Collective Reprobation': '群體斷罪',
        'Divine Judgment': '神聖審判',
        'Divine Spear': '神聖火焰',
        'Double Rocket Punch': '雙重火箭拳擊',
        'Down for the Count': '擊倒',
        'Drainage': '排水',
        'Earth Missile': '大地導彈',
        'Embolus': '填充水壓',
        'Enumeration': '計數',
