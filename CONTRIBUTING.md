...
and the new release attributes.

3. Upload this PR, and a release will happen automatically once the PR is merged.

4. If you set the release to draft (`-d`), make whatever changes are needed to the release notes
