...
|<img src="./resources/ffxiv/jobs/vpr-large.png" width="30px"/><br> Viper|**Resource zone**: Rattling Coil Stack, Serpent Offerings amount, combo timer, ViperSight gauge. <br> **Tracking zone**: Noxious Gnash duration, Hunter's Instinct duration, Swiftscaled duration, Dreadwinder cooldown.|
