...
|<img src="./resources/ffxiv/jobs/vpr.png" width="30px"/><br> Viper|**Resource zone**: Rattling Coil Stack, Serpent Offerings amount, combo timer, ViperSight gauge. <br> **Tracking zone**: Noxious Gnash duration, Hunter's Instinct duration, Swiftscaled duration, Vice Combo cooldown.|
...
|<img src="./resources/ffxiv/jobs/pct.png" width="30px"/><br> Pictomancer|**Resource zone**: Palette gauge, White/Black Paint Stack, Hammer Time timer, Living Canvas, Portrait. <br> **Tracking zone**: Living Muse cooldown, Steel Muse cooldown, Scenic Muse cooldown.|
