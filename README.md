...
|<img src="./resources/ffxiv/jobs/blm-large.png" width="30px"/><br> Black Mage|**Resource zone**: Umbral Ice/Astral Fire stack, Polyglot timer, Astral Soul stack, MP tick timer, Umbral Hearts stack & Polyglot stack, Firestarter/Paradox/Thunderhead proc. <br> **Tracking zone**: Thunder DoT duration, Manafont cooldown, Amplifier cooldown.|
